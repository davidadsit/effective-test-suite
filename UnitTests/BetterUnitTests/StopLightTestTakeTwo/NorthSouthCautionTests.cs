...
{
    [TestFixture]
    public class NorthSouthCautionTests
    {
        [SetUp]
        public void Setup()
        {
            InitialState = new NorthSouthCaution();
        }
        ...
        [Test]
        public void North_south_is_yellow()
        {
            Assert.That(InitialState.NorthSouthColor(), Is.EqualTo(LightColor.Yellow));
        }

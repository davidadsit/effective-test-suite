...
{
    [TestFixture]
    public class AllStopWhenPreviouslyNorthSouthCautionTests
    {
        [SetUp]
        public void Setup()
        {
            InitialState = new AllStop(new NorthSouthCaution());
        }
        ...
        {
            Assert.That(InitialState.TimerTick(), Is.TypeOf<EastWestFlow>());
        }
